...
(chaos-add-action 8 'Dialog '(chaos-start-dialog this object-2))
(chaos-add-action 10 'Enemy '(chaos-set-object-id this 'ea 'enemy))
...
(chaos-add-action 115 'set-global-timer '(chaos-set-global-timer text-1 integer-1))
