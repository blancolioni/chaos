...
(chaos-add-trigger #x1C 'See '(and object (chaos-can-see this object)))
...
(chaos-add-trigger #x2F 'Heard '(and object (<= (chaos-distance this object) 6) (chaos-script-flag object 'shout integer-1)))
